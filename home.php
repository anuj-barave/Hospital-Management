   ...
   <br>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="login.php">Appointment</a></li>
         
          <li><a class="nav-link scrollto" href="login.php">Login</a></li>
          <li><a class="nav-link scrollto" href="doctor2.php">Doctor_Side</a></li>
          <li><a class="nav-link scrollto" href="admin1.php">Admin_Side</a></li>
        ...
        <h1 data-aos="fade-up">Hey, Welcome !</h1>
          ...
          <div ><br><br>
            <div class="text-center text-lg-start">
              <a onclick="myFunction()" href="patient.php" class="btn btn btn_primary scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                <span>Sign up</span>
